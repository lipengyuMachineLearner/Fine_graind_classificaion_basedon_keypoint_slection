...
const float KMEANS_STOP_THRESHOLD_SIFT = 0.05;

const int SPLIT_STOP_ITERATION_SIFT = 20;
const float SPLIT_THRESHOLD_SIFT = 0.001;
...
const float KMEANS_STOP_THRESHOLD_HOC = 0.007;
const int SPLIT_STOP_ITERATION_HOC = 10;
const float SPLIT_THRESHOLD_HOC = 0.002;
