...
const int KMEANS_STOP_ITERATION = 500;
const float KMEANS_STOP_THRESHOLD = 0.0005;

const int SPLIT_STOP_ITERATION = 20;
const float SPLIT_THRESHOLD = 0.001;
const float MIN_INTIAL = 1/128*0;
